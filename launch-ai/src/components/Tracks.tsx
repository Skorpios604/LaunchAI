      ...
      <div className="container mx-auto px-6 max-w-[1200px] relative z-10">
        ...
        >
          ...
          <h2 className="text-3xl md:text-5xl font-bold mb-4 text-white tracking-tight" style={{ fontFamily: "var(--font-orbitron)" }}>
            CHOOSE YOUR <span className="text-[#00ff88]">PATH.</span>
          </h2>
          <p className="text-lg text-gray-400 leading-relaxed">
            Pick the track that matches your experience level and career goals.
          </p>
        </motion.div>
        ...
        >
          ...
          <motion.div variants={itemVariants} className="tech-glass p-8 flex flex-col group border-t-2 border-t-[#0a66c2]/50 hover:border-t-[#0a66c2] transition-colors relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="text-xs text-gray-400 mb-8 leading-relaxed font-mono uppercase">
                Perfect for those starting their AI journey.
              </p>
              <ul className="space-y-4 text-gray-300 font-mono text-sm mb-8 flex-grow">
                <li className="flex items-start gap-3"><CheckSquare className="text-[#0a66c2] shrink-0 mt-0.5" size={16} /> Python Fundamentals</li>
                <li className="flex items-start gap-3"><CheckSquare className="text-[#0a66c2] shrink-0 mt-0.5" size={16} /> Intro to Machine Learning</li>
          ...
          <motion.div variants={itemVariants} className="tech-glass p-8 flex flex-col border border-[#00f0ff] relative bg-[#00f0ff]/5 transform md:-translate-y-4 shadow-[0_0_30px_rgba(0,240,255,0.15)] overflow-hidden">
            ...
            <div className="relative z-10 mt-4">
              ...
              <p className="text-xs text-gray-400 mb-8 leading-relaxed font-mono uppercase">
                Build and deploy intelligent systems end-to-end.
              </p>
              <ul className="space-y-4 text-white font-mono text-sm mb-8 flex-grow">
                <li className="flex items-start gap-3"><CheckSquare className="text-[#00f0ff] shrink-0 mt-0.5" size={16} /> LLM Application Development</li>
                <li className="flex items-start gap-3"><CheckSquare className="text-[#00f0ff] shrink-0 mt-0.5" size={16} /> RAG Systems</li>
          ...
          <motion.div variants={itemVariants} className="tech-glass p-8 flex flex-col group border-t-2 border-t-[#b026ff]/50 hover:border-t-[#b026ff] transition-colors relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="text-xs text-gray-400 mb-8 leading-relaxed font-mono uppercase">
                Train models, build pipelines, and master MLOps.
              </p>
              <ul className="space-y-4 text-gray-300 font-mono text-sm mb-8 flex-grow">
                <li className="flex items-start gap-3"><CheckSquare className="text-[#b026ff] shrink-0 mt-0.5" size={16} /> Model Training</li>
                <li className="flex items-start gap-3"><CheckSquare className="text-[#b026ff] shrink-0 mt-0.5" size={16} /> Data Pipelines</li>
