      ...
      <div className="container mx-auto px-6 max-w-[1200px] relative z-10">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl font-bold mb-6 text-white tracking-tight leading-tight">
            THE SYNERGY <span className="text-neon-gradient">PROTOCOL.</span>
          </h2>
          <p className="text-lg text-gray-400 max-w-2xl mx-auto">
            You don't just write code. You synchronize within a pod of 5-7 specialized agents to compile exactly 1 monolithic product.
          </p>
        </motion.div>
        ...
        >
          ...
          <motion.div variants={itemVariants} className="tech-glass p-6 flex flex-col relative overflow-hidden group border-t-2 border-t-[#ff2a5f]">
            <div className="absolute top-0 right-0 p-2 opacity-20 group-hover:opacity-100 transition-opacity">
              <span className="text-[#ff2a5f] text-[10px] font-mono">ID: PM-01</span>
            </div>
            <div className="flex items-center gap-4 mb-4 mt-2">
              ...
              <div>
                ...
                <h3 className="text-xl font-bold text-white">1x Unit</h3>
              </div>
            </div>
            <p className="text-gray-400 text-sm leading-relaxed border-l border-white/10 pl-4 mt-2">
              Vision directive, roadmap compilation, user experience design, and sprint execution.
            </p>
          </motion.div>
          ...
          <motion.div variants={itemVariants} className="tech-glass bg-gradient-to-b from-[#0a66c2]/10 to-transparent p-6 flex flex-col relative overflow-hidden group border-t-2 border-t-[#0a66c2] transform md:-translate-y-4 shadow-[0_0_30px_rgba(10,102,194,0.1)]">
            <div className="absolute top-0 right-0 p-2 opacity-20 group-hover:opacity-100 transition-opacity">
              <span className="text-[#0a66c2] text-[10px] font-mono">ID: AI-02</span>
            </div>
            <div className="flex items-center gap-4 mb-4 mt-2">
              ...
              <div>
                <div className="text-[10px] font-bold text-[#00f0ff] tracking-widest uppercase mb-1" style={{ fontFamily: "var(--font-orbitron)" }}>Core AI/ML</div>
                <h3 className="text-xl font-bold text-white">2-3x Units</h3>
              </div>
            </div>
            <p className="text-gray-300 text-sm leading-relaxed border-l border-[#0a66c2]/30 pl-4 mt-2">
              LLM model integration, RAG vector synchronization, agent fine-tuning, and model deployment.
            </p>
          </motion.div>
          ...
          <motion.div variants={itemVariants} className="tech-glass p-6 flex flex-col relative overflow-hidden group border-t-2 border-t-[#00ff88]">
            <div className="absolute top-0 right-0 p-2 opacity-20 group-hover:opacity-100 transition-opacity">
              <span className="text-[#00ff88] text-[10px] font-mono">ID: BE-03</span>
            </div>
            <div className="flex items-center gap-4 mb-4 mt-2">
              ...
              <div>
                <div className="text-[10px] font-bold text-[#00ff88] tracking-widest uppercase mb-1" style={{ fontFamily: "var(--font-orbitron)" }}>Infrastructure</div>
                <h3 className="text-xl font-bold text-white">1x Unit</h3>
              </div>
            </div>
            <p className="text-gray-400 text-sm leading-relaxed border-l border-white/10 pl-4 mt-2">
              API endpoint generation, scalable database structures, and server microservices.
            </p>
          </motion.div>
          ...
          <motion.div variants={itemVariants} className="tech-glass p-6 flex flex-col relative overflow-hidden group lg:col-start-1 border-t-2 border-t-[#fce000]">
            <div className="absolute top-0 right-0 p-2 opacity-20 group-hover:opacity-100 transition-opacity">
              <span className="text-[#fce000] text-[10px] font-mono">ID: FE-04</span>
            </div>
            <div className="flex items-center gap-4 mb-4 mt-2">
              ...
              <div>
                <div className="text-[10px] font-bold text-[#fce000] tracking-widest uppercase mb-1" style={{ fontFamily: "var(--font-orbitron)" }}>Interface Arch</div>
                <h3 className="text-xl font-bold text-white">1x Unit</h3>
              </div>
            </div>
            <p className="text-gray-400 text-sm leading-relaxed border-l border-white/10 pl-4 mt-2">
              Constructing responsive, highly-interactive glassmorphic terminal interfaces.
            </p>
          </motion.div>
          ...
          <motion.div variants={itemVariants} className="tech-glass p-6 flex flex-col relative overflow-hidden group border-t-2 border-t-[#b026ff]">
            <div className="absolute top-0 right-0 p-2 opacity-20 group-hover:opacity-100 transition-opacity">
              <span className="text-[#b026ff] text-[10px] font-mono">ID: DE-05</span>
            </div>
            <div className="flex items-center gap-4 mb-4 mt-2">
              ...
              <div>
                <div className="text-[10px] font-bold text-[#b026ff] tracking-widest uppercase mb-1" style={{ fontFamily: "var(--font-orbitron)" }}>Data Eng</div>
                <h3 className="text-xl font-bold text-white">1x Unit</h3>
              </div>
            </div>
            <p className="text-gray-400 text-sm leading-relaxed border-l border-white/10 pl-4 mt-2">
              Data pipelines, vector embedding databases, and tensor preprocessing workflows.
            </p>
          </motion.div>
        </motion.div>
      </div>
